...
ln -svf $DIR/zsh/zprofile               ~/.zprofile
...
# ln -svf $DIR/jupyter/jupyter_notebook_config.py ~/.jupyter/jupyter_notebook_config.py
# ln -svf $DIR/jupyter/plugin.jupyterlab-settings ~/.jupyter/lab/user-settings/@jupyterlab/shortcuts-extension/plugin.jupyterlab-settings
