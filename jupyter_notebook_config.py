...
#------------------------------------------------------------------------------
# New Modifications (added 11/26/18)
#------------------------------------------------------------------------------
# Run JupyterLab in Desktop Mode
c.LabApp.browser = '/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome --new-window --incognito --app=%s'
...
#c.LabApp.user_settings_dir = '/Users/Fer/.jupyter/lab/user-settings'

## Whether to serve the app in watch mode
#c.LabApp.watch = False

## The directory for workspaces
#c.LabApp.workspaces_dir = '/Users/Fer/.jupyter/lab/workspaces'
